...
console.log("파일의 이름(확장자 없는)", path.basename(fileName.path.extance(fileName));

//path.join --> 상대 경로 작성법으로 절대 경로를 만들어주는 메서드
// .. -> 상위 디렉토리로 이동
const userPath = path.join(__dirname,'..','..','..'"/test_floder", "/test.js");
